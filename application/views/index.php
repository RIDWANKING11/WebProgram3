...
<body>
    <div class="container">
        ...
        <section>
            ...
            <ol type="a">
                <li>Model</li>
                <p align='justify'>Model adalah kelas yang merepresentasikan atau memodelkan tipe data yang akan digunakan oleh aplikasi. Model juga dapat didefinisikan sebagai bagian penanganyang berhubungan dengan pengolahan atau manipulasi database. Seperti misalnya mengambil data
